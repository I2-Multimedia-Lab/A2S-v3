...
def base_config(cfg_dict):
    ...
    parser.add_argument('--finetune', action='store_true', help='Few shot')
    parser.add_argument('--load', default='./pretrain/', help='Few shot')
    parser.add_argument('--pcl', default=True, type=bool, help='Few shot')
